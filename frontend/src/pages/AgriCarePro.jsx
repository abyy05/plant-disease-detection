        ...
        <>
                ...
                <div className="about-container">
                    ...
                    <div className="about-text">
                        <ul style={{ listStyleType: "disc" }}>
                            <li>🌿 Silent Threat: Plant diseases often spread unnoticed, destroying crops and months of hard work.</li>
                            <li>🌿 Late Detection: Farmers usually identify infections too late, when the damage can’t be reversed.</li>
                            <li>🌿 Unpredictable Challenges: Sudden weather shifts and lack of timely insights worsen the crisis.</li>
                            <li>🌿 Limited Support: Many farmers struggle without expert advice or modern tools.</li>
                            <li>🌿 Deep Impact: These problems go beyond harvest loss — they threaten livelihoods, food security, and hope.</li>
                        </ul>
            ...
            <div className="about-agriCarePro1">
                ...
                <div className="about-container">
                    ...
                    <div className="about-text">
                        <ul style={{ listStyleType: "disc" }}>
                            <li>🌿 Instant Detection: Farmers can quickly identify plant diseases by simply capturing an image of the affected crop.</li>
                            <li>🌿 AI-Powered Analysis: Our smart system analyzes the image within seconds for accurate, reliable results.</li>
                            <li>🌿 Actionable Insights: Get clear information on the disease, along with preventive and treatment tips.</li>
                            <li>🌿 Weather-Based Guidance: Receive timely weather updates to plan and protect crops effectively.</li>
                            <li>🌿 Empowering Farmers: AgriCare Pro helps farmers act fast, safeguard their fields, and secure a healthy, thriving harvest.</li>
            ...
            <div className="about-agriCarePro2">
                ...
                <div className="about-container">
                    ...
                    <div className="about-text">
                        <ul style={{ listStyleType: "disc" }}>
                            <li>🌿 Smart Agriculture: AgriCare Pro — Smart Plant Disease Detection and Weather Advisory.</li>
                            <li>🌿 Instant Detection: Farmers can instantly identify plant diseases with our advanced platform.</li>
                            <li>🌿 Accurate Weather Insights: Receive precise, real-time weather advisories for better farm planning.</li>
                            <li>🌿 Innovation Made Simple: Our platform blends cutting-edge innovation with easy-to-use design for every farmer.</li>
                            <li>🌿 Sustainable Growth: We help farmers protect crops, improve yields, and adopt sustainable farming practices.</li>
                            <li>🌿
